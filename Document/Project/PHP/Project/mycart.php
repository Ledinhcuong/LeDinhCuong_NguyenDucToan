				...
				<div class="row" style="background: #F0F0F0;">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="img-product">
									<img src="public/images/iphonex.jpg" alt="" class="img-responsive">
								</div>
							...
							<div class="col-md-6">
								<div class="detail-pr">
									...
									<div class="add-product" style="font-size: 25px; color: #FE7E10; ">
					...
					<div class="col-md-6 pay-product">
						...
						<ul>
							...
							<li>Đơn giá: 300000 đ</li>
							<li>Số lượng: 1</li>
							<li>Tổng cộng: 30000 đ</li>
						</ul>
