...
<body>	
	...
	<div class="content">
		<div class="them-sp" style="margin: 50px 0;">
			<div class="container">
				<form action="themloai.php" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data" onsubmit="return validateLoai();">
					<div class="form-group">
						<legend style="color: #009688">Thêm loại</legend>
