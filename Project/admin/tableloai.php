	...
	<div class="content">
		<div class="container">
			...
			<div class="list-table">
				<div class="name-list">Bảng Loại</div>
				<div class="add-product">
					<a href="formthemloai.php" style="font-size: 30px; margin-bottom: 10px;"><i class="fa fa-plus-square-o" aria-hidden="true"></i></a>
				</div>
				<div class="table">
					<div class="title">
						<div class="row">
							<div class="col-md-2 b-title">Mã loại</div>
							<div class="col-md-2 b-title">Tên loai</div>
							<div class="col-md-2 b-title">Thao tác</div>

						</div>
					</div>
					<?php
					$total_rows= $loai->coutAllLoai();
					$per_page= 10;
					...
					$danhsach = $loai->tatCaLoai($page,$per_page);
					foreach ($danhsach as $key) {
						?>
						<div class="row">
							<div class="col-md-2 s-title"><?php echo $key['MaLoai']?></div>
							<div class="col-md-2 s-title"><?php echo $key['TenLoai']?></div>
							<div class="col-md-8 " style="padding-top: 20px;">

								<a href="editloai.php?MaLoai= <?php echo $key['MaLoai'];?>"><button>Sửa</button></a>
								<a href="xoaloai.php?MaLoai= <?php echo $key['MaLoai'];?>"><button>Xóa</button></a>
			...
			<div class="paging">
				<div class="container">
					<div class="all-page">
						<tr>
							<?php
								echo $loai->create_links($base_url, $total_rows, $page, $per_page);
							?>
						</tr>
