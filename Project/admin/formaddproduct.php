...
<body>	
	...
	<header class="top-header">
		...
		<div class="content">
			<div class="them-sp" style="margin: 50px 0;">
				<div class="container">
				<form action="themsanpham.php" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
					<div class="form-group">
						<legend style="color: #009688">Thêm sản phẩm</legend>
					...
					<div class="form-group">
						<label for="anh" class="col-sm-2 control-label">Tệp ảnh </label>
						<div class="col-sm-10">
							<input type="file" id="anh" name="anh" class="form-control" style="opacity: 0.5;">
							<span class="help-block"></span>
						</div>
					</div>
